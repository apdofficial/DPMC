...
assert(os.environ.has_key('DPMC'))

w = 0.5
if len(sys.argv) > 3:
	w_check = float(sys.argv[3])
	if w_check > 0:
		w = w_check
...
cmd3 = os.environ['DPMC']+'lg/build/lg "'+os.environ['DPMC']+'lg/solvers/flow-cutter-pace17/flow_cutter_pace17 -s 1234567 -p 100" < '+cnf+' | '+os.environ['DPMC']+'dmc/dmc --pw='+str(pw)+' --cf='+cnf+' --lc=1 --wc=1 --vs=2'
print cmd3
os.system(cmd3)
#print cmd2
#os.system(cmd2)
