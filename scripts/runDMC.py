...
cmd3 = os.environ['DPMC']+'lg/build/lg "'+os.environ['DPMC']+'lg/solvers/flow-cutter-pace17/flow_cutter_pace17 -s 1234567 -p 100" < '+cnf+' | '+os.environ['DPMC']+'dmc/dmc'+dmc+' --pw='+str(pw)+' --cf='+cnf+' --lc=1 --wc=1 --vs=2'
cmd3 = os.environ['DPMC']+'lg/build/lg "'+os.environ['DPMC']+'lg/solvers/flow-cutter-pace17/flow_cutter_pace17 -s 1234567 -p 100" < '+cnf+' | '+os.environ['DPMC']+'dmc/dmc_original'+dmc+' --pw='+str(pw)+' --cf='+cnf+' --dp=c --lc=1 --wc=0 --vs=2 --pc=1'
